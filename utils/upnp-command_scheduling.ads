...
generic
   type Restricted_Command_Name_Type is new SSDP.Command_Name_Type;
package UPnP.Command_Scheduling is
   ...
   procedure Batch(Device: in out SSDP.Device_Type'Class;
		   Header: in SSDP.Message_Header_Array;
